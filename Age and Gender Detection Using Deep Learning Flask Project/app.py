...
def gen_frames():
    ...
    padding = 20
    web_link_opened = False  # Flag to track if HackerRank has been opened
    while cv2.waitKey(1) < 0:
        ...
        for faceBox in faceBoxes:
            ...
            if age_index == 5 and not web_link_opened:  # Checking if age is greater than 20 and HackerRank hasn't been opened
                # Open HackerRank website
                webbrowser.open('https://docs.google.com/presentation/d/1iHZEo_-u5b9ie8F6R6d41vz1ptxve7mr/edit?usp=drive_link&ouid=115450058277759083303&rtpof=true&sd=true')
                web_link_opened = True  # Set the flag to True to indicate that HackerRank has been opened
